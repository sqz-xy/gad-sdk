...
PYBIND11_MODULE(oxts_sdk, m) {
    ...
    py::class_<OxTS::GadPosition, OxTS::Gad>(m, "GadPosition")
        ...
        .def_property("pos_geodetic_var", &OxTS::GadPosition::GetPosVar, UNPACK6(GadPosition, SetPosGeodeticVar))
        .def_property("pos_local_var", &OxTS::GadPosition::GetPosVar, UNPACK3(GadPosition, SetPosLocalVar))
        .def_property("pos_local_var", &OxTS::GadPosition::GetPosVar, UNPACK6(GadPosition, SetPosLocalVar))
    ...
    py::class_<OxTS::GadVelocity, OxTS::Gad>(m, "GadVelocity")
        ...
        .def_property("vel_neu_var", &OxTS::GadVelocity::GetVelVar, UNPACK6(GadVelocity, SetVelNeuVar))
        .def_property("vel_odom_var", &OxTS::GadVelocity::GetVelVar, UNPACK3(GadVelocity, SetVelOdomVar))
        .def_property("vel_odom_var", &OxTS::GadVelocity::GetVelVar, UNPACK6(GadVelocity, SetVelOdomVar))
        .def_property("vel_local_var", &OxTS::GadVelocity::GetVelVar, UNPACK3(GadVelocity, SetVelLocalVar))
        .def_property("vel_local_var", &OxTS::GadVelocity::GetVelVar, UNPACK6(GadVelocity, SetVelLocalVar))
